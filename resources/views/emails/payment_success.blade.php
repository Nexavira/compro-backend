        ...
        <table class="main" width="100%">
            ...
            <tr>
                <td class="content">
                    ...
                    <p class="instructions">Silakan klik tombol di bawah ini untuk login ke dashboard admin Anda menggunakan email dan password yang telah Anda daftarkan.</p>
                    <div class="cta-container">
                        <a href="{{ url('/admin') }}" class="btn" target="_blank">Login Dashboard</a>
                    </div>

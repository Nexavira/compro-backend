        ...
        <table class="main" width="100%">
            <tr>
                <td class="header">
                    ...
                    <p>Layanan Ditangguhkan</p>
                </td>
            </tr>
            <tr>
                <td class="content">
                    <div class="badge" style="background-color: #f3f4f6; color: #4b5563; border-color: #e5e7eb;">
                        <span class="badge-dot" style="background-color: #6b7280;"></span>Layanan Ditangguhkan
                    </div>
                    <h2>Halo, {{ $user->name ?? 'Admin' }}!</h2>
                    <div class="message-card">
                        <p>Mohon maaf, layanan untuk company profile {{ $tenant->name ?? 'Tenant' }} telah ditangguhkan sementara karena masa berlaku langganan Anda telah berakhir dan pembayaran tagihan belum kami terima.</p>
                        <br>
                        <p>Website Anda saat ini tidak dapat diakses publik. Segera selesaikan pembayaran untuk mengaktifkan kembali layanan Anda.</p>
                    </div>
                    <p class="instructions">Silakan klik tombol di bawah ini untuk menuju dashboard dan mengunggah bukti pembayaran Anda agar layanan dapat diaktifkan kembali.</p>
                    <div class="cta-container">
                        <a href="{{ url('/admin') }}" class="btn" style="background: linear-gradient(135deg, #1f2937 0%, #374151 100%);" target="_blank">Bayar Tagihan Sekarang</a>
                    </div>

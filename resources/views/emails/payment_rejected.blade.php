...
<body>
    <center class="wrapper">
        <table class="main" width="100%">
            ...
            <tr>
                <td class="content">
                    <div class="badge" style="background-color: #fef2f2; color: #dc2626; border-color: #fecaca;">
                        <span class="badge-dot" style="background-color: #ef4444;"></span>Pembayaran Ditolak
                    </div>
                    <h2>Halo, {{ $user->name ?? 'Admin' }}!</h2>
                    <div class="message-card">
                        <p>Mohon maaf, bukti pembayaran untuk company profile {{ $tenant->name ?? 'Tenant' }} tidak dapat kami verifikasi atau tidak valid. Silakan unggah ulang bukti pembayaran yang benar.</p>
                    </div>
                    <p class="instructions">Silakan klik tombol di bawah ini untuk menuju dashboard dan mengunggah ulang bukti pembayaran Anda.</p>
                    <div class="cta-container">
                        <a href="{{ url('/admin') }}" class="btn" target="_blank">Upload Ulang Bukti Bayar</a>
                    </div>
